 ...
 */
void setdbgcfg(void) ATTRIBUTE(cold);
 ...
 */
void dbg_log(const char *restrict fmt, ...) ATTRIBUTE(nonnull, format(printf, 1, 2));
void info_log(const char *restrict fmt, ...) ATTRIBUTE(nonnull, format(printf, 1, 2));
void warn_log(const char *restrict fmt, ...) ATTRIBUTE(nonnull, format(printf, 1, 2));
void err_log(const char *restrict fmt, ...) ATTRIBUTE(nonnull, format(printf, 1, 2));
...
void rvrunpanic(const char *restrict file, const char *restrict func, int line,
		const char *restrict reason) ATTRIBUTE(nonnull, noreturn);
