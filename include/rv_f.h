...
int insn_fsgnj_s(struct proc *proc, insn_t insn) ATTRIBUTE(nonnull);
int insn_fsgnjn_s(struct proc *proc, insn_t insn) ATTRIBUTE(nonnull);
...
int insn_fclass_s(struct proc *proc, insn_t insn) ATTRIBUTE(nonnull);
