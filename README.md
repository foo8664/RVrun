...
First, clone the repository, and `cd` into it. The Makefile provides 4 targets:
...
are installing in `<path>/bin`, instead of /usr/local/bin.
...
$ # RvRun can now be used like any other program
```
...
displaying copyrighting and licensing.
